...
describe('Given logger', () => {
  describe('When called', () => {
    it('passes to next the function', async () => {
      ...
      validator(requestObject, requestObject, requestObject);
    ...
    it('can throw an error', () => {
      ...
      expect(() => validator(requestObject, requestObject, nextFunction)).toThrow(Error);
      expect(() => validator(requestObject, requestObject, nextFunction)).toThrow('id not provided');
    });
  });
});
